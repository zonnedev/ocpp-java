...
/** Immutable schema type generated from schemas/v201/GetReportResponse.json. */
public record GetReportResponse(
  ...
  public static GetReportResponse of(GenericDeviceModelStatusEnum status) {
  ...
  public static GetReportResponse of(
    @Nullable CustomData customData,
    GenericDeviceModelStatusEnum status,
    @Nullable StatusInfo statusInfo
  ) {

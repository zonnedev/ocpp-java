 ...
 * schemas/v16/RemoteStopTransactionResponse.json.
 */
public record RemoteStopTransactionResponse(
  ...
  public static RemoteStopTransactionResponse of(Status status) {
    return new RemoteStopTransactionResponse(status);
  }

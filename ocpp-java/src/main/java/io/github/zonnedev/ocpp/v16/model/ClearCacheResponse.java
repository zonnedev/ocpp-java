...
/** Immutable schema type generated from schemas/v16/ClearCacheResponse.json. */
public record ClearCacheResponse(
  ...
  public static ClearCacheResponse of(Status status) {
    return new ClearCacheResponse(status);
  }
